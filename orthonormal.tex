...
\subsection{orthonormal conditions on $m_j$}
...
\subsection{ Design and Boundary Regularity of $m_j$}\label{sec: design}
...
Because of the discontinuity at $\partial C_j$, the boundaries of the $C_j$, the $m_j$ are not smooth, and hence the corresponding wavelets are not spatially localized. The $m_j$ can be regularized by smoothing at the $\partial C_j$.
