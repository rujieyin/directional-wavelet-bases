...
Furthermore, these wavelets are well localized in the frequency domain. \textcolor{blue}{In particular, for a fixed small $\epsilon>0$, we can construct $m_j$ such that  $supp(m_j)$ is convex and}%  $\exists\,\epsilon\; s.t.$
